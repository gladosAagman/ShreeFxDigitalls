          ...
          {filtered.map((service, i) => {
            ...
            return (
              <div
                key={service.slug}
                className={cn(
                  "overflow-hidden rounded-[var(--radius-xl)] border border-neutral-200 bg-surface shadow-[var(--shadow-lg)] transition-all hover:-translate-y-1 hover:shadow-[var(--shadow-xl)]",
                  accent.glow
                )}
              >
