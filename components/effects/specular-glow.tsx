...
export interface SpecularGlowProps {
...
export function SpecularGlow({
  ...
  return <span ref={fxRef} className="specular-wrap__fx" aria-hidden="true" />;
}
