...
export function GridScan({
  ...
  // Face-tracking models are only fetched when webcam tracking is actually
  // requested — most usages are a passive background effect, so we skip the
  // network + parse cost of loading ML weights entirely by default.
  useEffect(() => {
